...
import product6 from '../images/bekh.jpg'
...
,
{
    ...
    image:product8,
    name:"Gurbach",
 description: "It is a monocot species of a flowering plant that is native to Eastern Asia and North America. Certain types of Vacha have also been found in the Himalayas and have been used widely in traditional medicines for their umpteen health benefitting properties.Vacha is a powerful medicinal herb imbued with immense therapeutic qualities, used extensively in the holistic science of Ayurvedic medicine since the times of Chakara and Sushruta.The name “Vacha” originated from Sanskrit, which means speaking clearly, as this herb works incredibly well to stimulate intelligence and expression.. Useful in stomach problems. Boosts Immune System. Useful in Digestion. Useful in Cough and cold."
},
...

{
    ...
    image:product11,
    name:"kalpasi",
 description: "Black Stone Flower is one of the most unusual spices in the Indian repertoire. It is a rare dried flower and a dominant spice in all Chettinad preparations. Black Stone Flower or Dagad Phool is a soft brown and black coloured lichen that gives the signature black color to various masalas like Goda Masala/Kala Masala. It has a strong earthy aroma and a very dry, light fluffy texture and feel to it. It is widely used in Chettinad cuisine and to some extent in Hyderabadi and Marathi cuisine. It is an edible lichen flora (a type of fungus), which grows on trees, rocks and stones. When used in small quantities, it imparts a strong woody aroma and flavor to the preparation. For better results it should be roasted in a little oil to release its full aroma."
}
,

{
    ...
    image:product12,
    name:"Dalchini",
 description: "Bliss of Earth Stone Flowers also called as patthar ke phool or dagad phool in hindi is one of the most unusual spices in the indian repertoire. it is a rare dried flower and a dominant spice in all Chettinad preparations. Also known as kalpasi, stone flower is a soft brownish and black coloured lichen that gives the signature black color to various cuisine. It has a strong earthy atom and a very dry, light fluffy texture and fell to it. It is widely use in chettinad cuisine and to some extent in Hyderabadi and Marathi cuisine. Cinnamon, as most of the cinnamon in the global market is Cassia. Bliss of Earth helps cinnamon lovers to provide pure Ceylon Cinnamon, also known as true cinnamon which gives superior quality, taste and aroma while conditioning the better health of cinnamon lovers. bliss of Earth brings you the extraction of Mother earth from the hill country of Sri Lanka supporting small scale farmers while making our customers feel the perfection of ultimate taste and goodness of real ceylon cinnamon."
},
...

{
    ...
    image:product14,
    name:"jatamansi",
 description: "Jatamansi, also known as “tapaswani” in Ayurveda, is a perennial, dwarf, hairy, herbaceous and endangered plant species. It acts as a brain tonic and helps to improve memory and brain functions by preventing cell damage due to its antioxidant property. It also calms down the brain and manages anxiety as well as insomnia.According to Ayurveda, Jatamansi helps in preventing wrinkles due to its Snigdha (oily) nature. It also promotes wound healing due to its Ropan (healing) property. Taking Jatamansi powder along with honey once or twice a day helps to improve memory functions. "
},
{

    image:product15,
    name:"Kapoor kachri",
 description: "Also known as kapoor kachri, the kachri powder can promote hair growth and treat problems like dandruff and scalp infections. Because of its antioxidant and fortifying properties, kapoor kachri powder stimulates hair growth and strengthens hair follicles."
}
,
{
...
,
{
    ...
    image:product17,
    name:"Maida Lakdi",
 description: "Ayurvedic herb, Maida Lakadi is Analgesic, Digestive, Chronic cough, Vaataj vikaar. The bark of Litsea glutinosa, is one of the most popular of native drugs, is considered to be capable of relieving pain, & good for stomach are considered to be mildly astringent, include treatment of diarrohea & dysentery."
}
,
{
...

{
    ...
    image:product23,
    name:"Shikakai",
 description: "Shikakai powder is a natural Ayurvedic herb used by Indian women for its delicate cleansing properties for highly sensitive scalps and for strengthening, volumizing and conditioning purposes. To be used alone or in addition to other dyeing or conditioning herbs, it will give body and shine to your hair."
},
{

    image:product24,
    name:"Soapnut",
 description: "The soapnut contains the compound of saponin, which has natural cleansing properties, and therefore the soapnut can be used as a cleanser for hair, skin, and clothing. These saponins are also useful as insecticides, for purposes such as removing head lice off the scalp."
}
,
{
